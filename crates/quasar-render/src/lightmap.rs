...
impl LightmapBaker {
    ...
    ///
    /// The result is written into the returned [`Lightmap`].
    pub fn bake(triangles: &[BakerTriangle], config: &BakeConfig) -> Lightmap {
        ...
        for tri in triangles {
            // Compute bounding box of the triangle in lightmap space.
            ...
            for py in y0..=y1 {
                for px in x0..=x1 {
                        ...
                        Self::barycentric_sample(tri, u, v)
                    {
                        ...
                        lightmap.pixels[idx] =
                            [final_color.x, final_color.y, final_color.z, 1.0];
                    }
                }
            }
        }
