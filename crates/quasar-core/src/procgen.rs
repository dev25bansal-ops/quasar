...
//!
//! This module provides a comprehensive procedural generation system for creating
//! diverse game content including dungeons, terrain, cities, forests, and quests.
//!
//! # Features
//!
//! - **Procedural dungeon generator** — Room-based dungeon layouts with corridors
//! - **Procedural terrain generator** — Heightmap-based terrain generation
//! - **Procedural city generator** — Building placement and road networks
...
//!
//! ```rust,no_run
//! use quasar_core::procgen::{ProcGenTemplate, ProcGenConfig, ProcGenType};
//!
//! // Create a dungeon generator template
//! let template = ProcGenTemplate::dungeon();
//!
//! // Configure generation parameters
//! let config = ProcGenConfig {
//!     name: "My Dungeon".to_string(),
...
//! let result = template.generate(&config).unwrap();
//! println!("Generated {} rooms", result.rooms.len());
//! ```
//!
//! # Available Generators
//!
//! - `ProcGenType::Dungeon` — Room-based dungeons with corridors
//! - `ProcGenType::Terrain` — Heightmap-based terrain
//! - `ProcGenType::City` — Building placement and roads
//! - `ProcGenType::Forest` — Tree and foliage distribution
//! - `ProcGenType::Village` — Small village layouts
//! - `ProcGenType::Cave` — Cave systems with tunnels
//! - `ProcGenType::SpaceStation` — Space station layouts
//! - `ProcGenType::Quest` — Dynamic quest generation
//!
//! # Configuration
//!
...
//! - `size` — Dimensions of the generated area
//! - `density` — Density of generated elements
//! - `complexity` — Complexity of the generated content
//! - `custom_params` — Generator-specific parameters
...
///
/// ```rust
/// use quasar_core::procgen::ProcGenType;
///
/// let dungeon_type = ProcGenType::Dungeon;
/// let terrain_type = ProcGenType::Terrain;
/// ```
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub enum ProcGenType {
    /// Room-based dungeon layouts
    Dungeon,
    /// Heightmap-based terrain
    Terrain,
    /// Building placement and roads
    City,
    /// Tree and foliage distribution
    Forest,
    /// Small village layouts
    Village,
    /// Cave systems with tunnels
    Cave,
    /// Space station layouts
    SpaceStation,
...
///
/// ```rust
/// use quasar_core::procgen::{ProcGenConfig, ProcGenType};
///
/// let config = ProcGenConfig {
///     name: "My Dungeon".to_string(),
///     gen_type: ProcGenType::Dungeon,
...
/// Generated entity with position, rotation, and properties.
///
/// Represents a single entity generated by the procedural generation system.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Generated room with connections and entities.
///
/// Represents a single room in a dungeon or building layout.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// Contains all generated content including rooms, entities, paths, and spawn points.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
///
/// Provides a reusable configuration for generating specific types of content.
///
/// # Examples
///
/// ```rust
/// use quasar_core::procgen::ProcGenTemplate;
///
/// // Get a dungeon generator template
/// let dungeon_template = ProcGenTemplate::dungeon();
///
/// // Get a terrain generator template
/// let terrain_template = ProcGenTemplate::terrain();
///
/// // Get a city generator template
/// let city_template = ProcGenTemplate::city();
/// ```
